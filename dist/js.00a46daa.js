...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"js/utils/normalizeWheel.js":[function(require,module,exports) {
/**
 ...
 * @typechecks
 */
'use strict'; // Reasonable defaults
...
},{}],"js/utils/mouse.js":[function(require,module,exports) {
"use strict";
...
function getMousePosition(_ref) {
...
},{}],"bg-1.jpg":[function(require,module,exports) {
module.exports = "/bg-1.3f0482e5.jpg";
},{}],"bg-2.jpg":[function(require,module,exports) {
module.exports = "/bg-2.f950fd64.jpg";
},{}],"bg-3.jpg":[function(require,module,exports) {
module.exports = "/bg-3.12bf378e.jpg";
},{}],"bg-4.jpg":[function(require,module,exports) {
module.exports = "/bg-4.9febf31e.jpg";
...
var Scroll = /*#__PURE__*/function () {
  ...
  _createClass(Scroll, [{
    ...
    value: function onWheel(event) {
      var wheel = new _normalizeWheel.default(event);
      var delta = wheel.spinY * 50;
      this.scroll.off += delta * this.scroll.speed;
      this.scroll.target = this.scroll.off;
    }
  }, {
    key: "onScrollTouchStart",
    value: function onScrollTouchStart(event) {
      this.scroll.drag = true;
      event.preventDefault();
      this.startX = (0, _mouse.default)(event).x;
    }
  }, {
    key: "onScrollTouchEnd",
    value: function onScrollTouchEnd(event) {
      this.scroll.drag = false;
      this.scroll.off = this.scroll.target; // startX = event.touches ? event.touches[0].clientX : event.clientX;
      // console.log({startX})
    }
  }, {
    key: "onScrollTouchMove",
    value: function onScrollTouchMove(event) {
      if (!this.scroll.drag) return;

      var _getMousePosition = (0, _mouse.default)(event),
          x = _getMousePosition.x;

      this.distance = (x - this.startX) * -1;
      this.scroll.target = this.scroll.off + this.distance * this.scroll.speed; // console.log(scroll.target)
    }
  }, {
    key: "onScrollKeyboard",
    value: function onScrollKeyboard(event) {
    ...
    key: "onScrollUpdate",
    value: function onScrollUpdate() {
      var total = this.element.clientWidth - window.innerWidth;
      if (this.scroll.target < 0) this.scroll.target = 0;
      if (this.scroll.target > total) this.scroll.target = total;

      _gsap.default.to('.scroll', {
    ...
    value: function addEventListeners() {
      ...
      document.addEventListener('touchstart', this.onScrollTouchStart.bind(this), {
        passive: false
      });
...
new Scroll('.scroll'); // let windowWidth = window.innerWidth,
...
},{"gsap":"../node_modules/gsap/index.js","./utils/normalizeWheel":"js/utils/normalizeWheel.js","./utils/mouse":"js/utils/mouse.js","../bg-1.jpg":"bg-1.jpg","../bg-2.jpg":"bg-2.jpg","../bg-3.jpg":"bg-3.jpg","../bg-4.jpg":"bg-4.jpg"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "9741" + '/');
